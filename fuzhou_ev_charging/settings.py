...
支持本地开发（SQLite）和生产部署（PostgreSQL + Render）
"""
import os
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-fuzhou-ev-charging-system-2024-secret-key-change-in-production')
...
# 数据库配置 - 优先使用DATABASE_URL（Render提供）
